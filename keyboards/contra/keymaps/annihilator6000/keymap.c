...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_WORKMAN] = LAYOUT_planck_mit(
    ...
    LT3_TAB, KC_A,    KC_S,    KC_H,    KC_T,    KC_G,    KC_Y,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT,
   ...
   * Matrix/Ergo non-stagger layout used - moves the Z key to left side
   *   and shifts the rest of the bottom row slightly
   * ,-----------------------------------------------------------------------------------.
   * | ESC  |   Q  |   W  |   F  |   P  |   B  |   J  |   L  |   U  |   Y  |   ;  | Bksp |
   * |------+------+------+------+------+-------------+------+------+------+------+------|
   * |TAB/L3|   A  |   R  |   S  |   T  |   G  |   K  |   N  |   E  |   I  |   O  |  '   |
   * |------+------+------+------+------+------|------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   D  |   V  |   M  |   H  |   ,  |   .  |   /  |SH/EN |
   * |------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl | Alt  | Gui  | App  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
   * `-----------------------------------------------------------------------------------'
   */
  ...
  [_LOWER] = LAYOUT_planck_mit(
    ...
    KC_LSFT, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  S(KC_NUHS), S(KC_NUBS), KC_HOME, KC_END,  _______,
  ...
  /* FN Layer 3 - Hold Tab
   * ,-----------------------------------------------------------------------------------.
   * | Esc  | Calc | Webhm| Mail | Comp |      |      |      |      |      | PrtSc| Del  |
   * |------+------+------+------+------+-------------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |      |      |      |
   * |------+------+------+------+------+------|------+------+------+------+------+------|
   * | Caps |      |      |      |      |      |      |      |      |      |      |      |
  ...
  [_TAB] = LAYOUT_planck_mit(
    KC_ESC,  KC_CALC, KC_WHOM, KC_MAIL, KC_MYCM, _______, _______, _______, KC_INS,  _______, KC_PSCR, KC_DEL,
   ...
   * |------+------+------+------+------+-------------+------+------+------+------+------|
   * |MuMode|Aud on|Audoff|AGnorm|AGswap|      |Qwerty|Wrkman| ModDH|Colemk|Dvorak|Plover|
   * |------+------+------+------+------+------|------+------+------+------+------+------|
  ...
  [_ADJUST] = LAYOUT_planck_mit(
    ...
    MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, _______, QWERTY,  WORKMAN, COLEMAK_MOD_DH, COLEMAK, DVORAK, PLOVER,
    _______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  TERM_ON, TERM_OFF, _______, _______, _______,
    DEBUG,   _______, _______, _______, _______,     _______,      _______, _______,  _______, _______, _______
  )
  /*
     When on QWERTY layout:
     QWERTY    = H
     WORKMAN   = J
     COLEMAK   = K
       -MOD-DH = L
