...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT_planck_mit(
    ...
    KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, _______,     _______,      _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
  ),
  ...
  [_TAB] = LAYOUT_planck_mit(
    KC_ESC,  KC_CALC, KC_WHOM, KC_MAIL, KC_MYCM, _______, _______, _______, _______, _______, KC_PSCR, KC_DEL,
