...
[_LOWER] = LAYOUT(
   ...
   * |      |     |     |     |     |     |     |  -  |  =  |  [  |  ]  |  \   |
   * |-------------------------------------------------------------------------+
   * | Shift | F11 | F12 | F13 | F14 | F15 | F16 | F17 | F18 | F19 | F20 |     |
   * |-------------------------------------------------------------------------+
   * | Next| Vol-| Vol+| Play|      |          |       | Home| PgDn| PgUp| End |
   * `-------------------------------------------------------------------------'
   */
[_RAISE] = LAYOUT(
  ...
  KC_LSFT, KC_F11,  KC_F12,  KC_F13,  KC_F14,  KC_F15,  KC_F16,  KC_F17,  KC_F18,  KC_F19,  KC_F20,  _______,
  KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, _______,     _______,      _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END
),
   ...
   */
[_TAB] = LAYOUT(
  KC_ESC,  KC_CALC, KC_WHOM, KC_MAIL, KC_MYCM, _______, _______, _______, KC_INS,  _______, KC_PSCR, KC_DELETE,
